...
use Illuminate\Support\Facades\Log;  // Added explicit import for Log
    ...
    public function index()
    {
        ...
        if ($studentClassData) {
            ...
            $registeredSubjects = DB::table('student_subject_register_record')
                ...
                ->pluck('subject.id')  // Fixed: Changed from 'subjectteacher.id' to 'subject.id'
                ->toArray();
        ...
        return view('cbt.index', [
            ...
            'totalreg' => $totalreg,
            'reg' => $reg,
            'attempts' => $attempts ?? [],  // New: Pass attempts array
        ]);
    }
    ...
    public function submit(Request $request)
    {
        try {
            ...
            $data = $request->validate([
                ...
                'answers.*.question_id' => 'required|integer|exists:questions,id',  // Fixed validation
