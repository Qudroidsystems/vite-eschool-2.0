...
<style>
    ...
    @media (max-width: 767px) {
        ...
        .table td.admissionno, .table td.name {
            font-size: 1.1rem;
            font-weight: 500;
        }
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Terminal Broadsheet</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('mysubjectvettings.index') }}">Subject Vetting</a></li>
                                <li class="breadcrumb-item active">Terminal Broadsheet</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h5 class="card-title mb-0">Terminal Broadsheet for {{ $schoolclass ? $schoolclass->schoolclass . ' ' . $schoolclass->arm : 'N/A' }} - {{ $schoolterm }} ({{ $schoolsession }})</h5>
                            </div>
                            <div class="card-body">
                                <div class="row mb-2">
