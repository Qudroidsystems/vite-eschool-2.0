    ...
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Mock Subject Vetting Management</a></li>
                                <li class="breadcrumb-item active">Mock Subject Vettings</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div id="mockSubjectVettingList">
                <!-- Bar Chart for Mock Vetting Status -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-4">Mock Vetting Status Distribution</h5>
                                ...
                                <div class="row g-3">
                                    <div class="col-xxl-3">
                                        <div class="search-box">
                                            <input type="text" class="form-control search" placeholder="Search mock subject vetting assignments">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <h5 class="card-title mb-0">Mock Subject Vetting Assignments <span class="badge bg-dark-subtle text-dark ms-1" id="total-records">{{ $mocksubjectvettings->count() }}</span></h5>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="d-flex flex-wrap align-items-start gap-2">
                                        <button class="btn btn-subtle-danger d-none" id="remove-actions" onclick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                        @can('Create mock-subject-vettings')
                                            <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#addMockSubjectVettingModal" id="create-mock-subject-vettings-btn"><i class="bi bi-plus-circle align-baseline me-1"></i> Create Mock Subject Vetting Assignment</button>
                                        @endcan
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_mock_subject_vetting_table">
                                        <thead>
                                        ...
                                        <tbody class="fw-semibold text-gray-600 list form-check-all">
                                            ...
                                            @forelse ($mocksubjectvettings as $sv)
                                                ...
                                                ?>
                                                <tr data-url="{{ route('mocksubjectvetting.destroy', $sv->svid) }}" class="{{ $rowClass }}">
                ...
                <!-- Add Mock Subject Vetting Modal -->
                <div id="addMockSubjectVettingModal" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" data-bs-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 id="addModalLabel" class="modal-title">Add Mock Subject Vetting Assignment</h5>
                            ...
                            <form class="tablelist-form" autocomplete="off" id="add-mocksubjectvetting-form">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="add-btn">Add Mock Subject Vetting Assignment</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- Edit Mock Subject Vetting Modal -->
                <div id="editMockModal" class="modal fade" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true" data-bs-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 id="editModalLabel" class="modal-title">Edit Mock Subject Vetting Assignment</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
